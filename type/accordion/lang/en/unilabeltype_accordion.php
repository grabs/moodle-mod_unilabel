...
$string['edit_info']         = 'You can use this type to display several elements one below the other as an accordion.<br>After saving, you can add elements using the "Edit content" button.';
