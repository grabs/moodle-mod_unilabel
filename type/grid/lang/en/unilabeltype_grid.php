...
$string['default_useajax']        = 'Default load content using Ajax';
$string['default_usemobile']      = 'Default use mobile images';
$string['edit_info']              = 'You can use this type to create elements that are displayed as a grid.<br>After saving, you can add elements using the "Edit content" button.';
...
$string['open_content']           = 'Open content for {$a}';
...
$string['use_ajax']               = 'Load content using Ajax';
$string['use_ajax_help']          = 'Ajax only works when the user is logged in! If you have set up the grid on the home page and users can see it without being logged in, you cannot use this feature.';
