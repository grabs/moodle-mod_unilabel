...
$string['edit_info']                = 'With this type you can display the sections of a course as a carousel or grid.<br>After saving, further settings can be found under the "Edit content" button';
$string['grid']                     = 'Grid';
