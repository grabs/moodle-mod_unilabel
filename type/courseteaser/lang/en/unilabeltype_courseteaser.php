...
$string['edit_info']                = 'For this type, courses can be defined whose description is displayed as teaser tiles in a carousel or a grid.<br>After saving, you can use the “Edit content” button to assign the courses and make further settings.';
$string['grid']                     = 'Grid';
