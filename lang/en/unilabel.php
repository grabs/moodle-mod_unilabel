...
$string['labeltype_help'] = 'With the label type you can define the art the content is shown. Each type has an exra configuration page.';
$string['modulename'] = 'Unilabel';
$string['modulename_help'] = 'The unilabel module enables you to include some nice formated text on the course page.';
